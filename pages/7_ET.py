                ...
                if can_edit:
                    with st.expander("✏️ Edit OPL", expanded=False):
                        with st.form(key=f"opl_edit_{opl['id']}"):
                            ...
                            e_subject  = e1.text_input("Subject", value=opl.get("subject",""))
